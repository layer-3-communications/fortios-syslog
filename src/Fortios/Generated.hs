...
pattern H_dstcountry = 4

pattern H_dstinetsvc :: Word
pattern H_dstinetsvc = 2
...
hashString2 arr off = rem (duohash 0 19225 12154 (Bytes arr off 2)) 4

hashString3 :: ByteArray -> Int -> Word
hashString3 arr off = rem (duohash 0 20211 64703 (Bytes arr off 2)) 8

hashString4 :: ByteArray -> Int -> Word
hashString4 arr off = rem (duohash 0 25463 5576 (Bytes arr off 4)) 2

hashString5 :: ByteArray -> Int -> Word
hashString5 arr off = rem (quadrohash 0 37830 53236 13741 1504 (Bytes arr off 4)) 16

hashString6 :: ByteArray -> Int -> Word
hashString6 arr off = rem (quadrohash 0 28219 20606 34461 61055 (Bytes arr off 4)) 16

hashString7 :: ByteArray -> Int -> Word
hashString7 arr off = rem (quadrohash 0 61151 51044 32418 28714 (Bytes arr off 4)) 32

hashString8 :: ByteArray -> Int -> Word
hashString8 arr off = rem (quadrohash 0 8296 37554 37989 975 (Bytes arr off 8)) 16

hashString9 :: ByteArray -> Int -> Word
hashString9 arr off = rem (quadrohash 0 38555 2299 6079 2185 (Bytes arr off 8)) 16

hashString10 :: ByteArray -> Int -> Word
hashString10 arr off = rem (quadrohash 0 39079 17814 16431 6287 (Bytes arr off 8)) 8

hashString11 :: ByteArray -> Int -> Word
hashString11 arr off = rem (duohash 0 43233 35180 (Bytes arr off 10)) 8

hashString12 :: ByteArray -> Int -> Word
hashString12 arr off = rem (duohash 0 57387 9393 (Bytes arr off 12)) 4

hashString13 :: ByteArray -> Int -> Word
hashString13 arr off = rem (duohash 0 14127 5912 (Bytes arr off 12)) 1

hashString16 :: ByteArray -> Int -> Word
hashString16 arr off = rem (duohash 0 63210 42139 (Bytes arr off 16)) 2
