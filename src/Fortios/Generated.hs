...
hashString2 arr off = rem (duohash 0 21981 34100 (Bytes arr off 2)) 4

hashString3 :: ByteArray -> Int -> Word
hashString3 arr off = rem (duohash 0 34683 58579 (Bytes arr off 2)) 32

hashString4 :: ByteArray -> Int -> Word
hashString4 arr off = rem (duohash 0 41909 62506 (Bytes arr off 4)) 2

hashString5 :: ByteArray -> Int -> Word
hashString5 arr off = rem (duohash 0 26758 53299 (Bytes arr off 4)) 64

hashString6 :: ByteArray -> Int -> Word
hashString6 arr off = rem (duohash 0 55376 22337 (Bytes arr off 6)) 32

hashString7 :: ByteArray -> Int -> Word
hashString7 arr off = rem (duohash 0 54675 1494 (Bytes arr off 6)) 64

hashString8 :: ByteArray -> Int -> Word
hashString8 arr off = rem (quadrohash 0 10316 29019 7636 5804 (Bytes arr off 8)) 32

hashString9 :: ByteArray -> Int -> Word
hashString9 arr off = rem (quadrohash 0 36749 17878 57960 59922 (Bytes arr off 8)) 32

hashString10 :: ByteArray -> Int -> Word
hashString10 arr off = rem (duohash 0 56618 43393 (Bytes arr off 10)) 16

hashString11 :: ByteArray -> Int -> Word
hashString11 arr off = rem (quadrohash 0 42214 42109 26518 9855 (Bytes arr off 8)) 8

hashString12 :: ByteArray -> Int -> Word
hashString12 arr off = rem (duohash 0 24725 44359 (Bytes arr off 12)) 8

hashString13 :: ByteArray -> Int -> Word
hashString13 arr off = rem (duohash 0 27135 60227 (Bytes arr off 12)) 1

hashString14 :: ByteArray -> Int -> Word
hashString14 arr off = rem (duohash 0 32777 32913 (Bytes arr off 14)) 1

hashString16 :: ByteArray -> Int -> Word
hashString16 arr off = rem (duohash 0 32997 11890 (Bytes arr off 16)) 2
