...
hashString2 arr off = rem (duohash 0 27645 60826 (Bytes arr off 2)) 4

hashString3 :: ByteArray -> Int -> Word
hashString3 arr off = rem (duohash 0 34865 41754 (Bytes arr off 2)) 16

hashString4 :: ByteArray -> Int -> Word
hashString4 arr off = rem (duohash 0 50797 45048 (Bytes arr off 4)) 2

hashString5 :: ByteArray -> Int -> Word
hashString5 arr off = rem (duohash 0 52102 2739 (Bytes arr off 4)) 64

hashString6 :: ByteArray -> Int -> Word
hashString6 arr off = rem (quadrohash 0 31542 38425 8712 50219 (Bytes arr off 4)) 16

hashString7 :: ByteArray -> Int -> Word
hashString7 arr off = rem (duohash 0 53075 12886 (Bytes arr off 6)) 64

hashString8 :: ByteArray -> Int -> Word
hashString8 arr off = rem (quadrohash 0 59347 53450 20714 60174 (Bytes arr off 8)) 32

hashString9 :: ByteArray -> Int -> Word
hashString9 arr off = rem (quadrohash 0 35187 63265 22516 12 (Bytes arr off 8)) 32

hashString10 :: ByteArray -> Int -> Word
hashString10 arr off = rem (duohash 0 60762 43857 (Bytes arr off 10)) 16

hashString11 :: ByteArray -> Int -> Word
hashString11 arr off = rem (duohash 0 50314 55727 (Bytes arr off 10)) 8

hashString12 :: ByteArray -> Int -> Word
hashString12 arr off = rem (duohash 0 47869 20983 (Bytes arr off 12)) 8

hashString13 :: ByteArray -> Int -> Word
hashString13 arr off = rem (duohash 0 44586 15694 (Bytes arr off 12)) 1

hashString14 :: ByteArray -> Int -> Word
hashString14 arr off = rem (duohash 0 30763 50490 (Bytes arr off 14)) 1

hashString16 :: ByteArray -> Int -> Word
hashString16 arr off = rem (duohash 0 10311 22698 (Bytes arr off 16)) 2
